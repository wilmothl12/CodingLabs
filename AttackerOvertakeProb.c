// Logan Wilmoth
// Program that calculates the probability of an attacker overtaking the blockchain
...
int main() {
    ...
    printf("\nThe probability of an attacker with \033[1;4m%.2f%%\033[0m of the networks computing power to overtake the blockchain when starting \033[1;4m%d\033[0m blocks behind is \033[1;4m%.20f%%\033[0m\n", q * 100, z, probability * 100);
